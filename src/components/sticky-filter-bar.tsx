                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {availableAmenities.map(amenity => (
                        <div key={amenity} className="flex items-center space-x-2 group cursor-pointer">
                          ...
                          />
                          <label htmlFor={`filter-${amenity}`} className="text-[10px] uppercase font-bold tracking-widest cursor-pointer text-muted-foreground group-hover:text-primary transition-colors">
                            {amenity}
                          </label>
                        </div>
                      ))}
