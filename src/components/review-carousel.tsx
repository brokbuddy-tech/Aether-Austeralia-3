...
const variantClasses: Record<ReviewCarouselVariant, {
  ...
  light: {
    ...
    card: 'rounded-[2rem] border border-primary/10 bg-white shadow-sm',
    quote: 'text-[#111111]/70',
    author: 'text-[#111111]',
    meta: 'text-primary',
    avatar: 'bg-primary text-white',
    avatarText: 'text-white',
    button: 'border border-primary/10 bg-white text-[#111111] hover:border-primary hover:text-primary',
  ...
  dark: {
    ...
    card: 'rounded-[2rem] border border-white/10 bg-white/[0.03] shadow-[0_24px_80px_rgba(0,0,0,0.28)]',
    quote: 'text-white/75',
    author: 'text-white',
    meta: 'text-white/45',
  ...
  blue: {
    ...
    card: 'rounded-[2rem] border border-white/20 bg-white text-[#111827] shadow-[0_24px_70px_rgba(9,17,36,0.18)]',
  ...
  gold: {
    ...
    title: 'text-white',
    description: 'text-white/55',
    card: 'rounded-[2rem] border border-white/10 bg-white/[0.04] shadow-[0_24px_80px_rgba(0,0,0,0.3)]',
    quote: 'text-white/72',
    author: 'text-white',
    meta: 'text-primary',
    avatar: 'bg-primary text-white',
    ...
    <section className={cn('px-6 py-20 md:px-12 md:py-24', styles.section, className)}>
      <div className="mx-auto w-full max-w-6xl">
        <div className="mb-10 text-center">
          <h2 className={cn('text-4xl font-headline font-extrabold uppercase md:text-5xl', styles.title)}>
            {title}
          </h2>
          {description ? (
        ...
        <div className="flex items-center justify-center gap-3 sm:gap-6">
          ...
          >
            ...
            <div className="mt-8">
              ...
              <p className={cn('mt-2 text-[10px] font-bold uppercase tracking-[0.24em]', styles.meta)}>
