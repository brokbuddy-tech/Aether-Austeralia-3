    ...
    <section className="relative w-full py-32 overflow-hidden bg-muted">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 max-w-2xl mx-auto">
          ...
          />
          <Button className="rounded-full px-12 py-5 bg-white hover:bg-primary text-foreground hover:text-white font-bold h-auto uppercase tracking-widest text-xs transition-colors border border-primary/10">
            Search
          </Button>
        </div>
      </div>
